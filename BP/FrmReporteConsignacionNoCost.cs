...
namespace BP
{
    public partial class FrmReporteConsignacionNoCost : Form
    {
        ...
        public FrmReporteConsignacionNoCost()
        {
            InitializeComponent();
        }

        private void FrmReporteConsignacionNoCost_Load(object sender, EventArgs e)
        {
        ...
        private void btnRun_Click(object sender, EventArgs e)
        {
            ...
            string rutaRpt = string.Format(@"{0}\RptConsignacionNoCost.rpt", appPath);
