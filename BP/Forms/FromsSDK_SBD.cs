...
namespace BP
{
    public partial class FromsSDK_SBD : Form
    {
        ...
        private void FromsSDK_SBD_Load(object sender, EventArgs e)
        {
            try
            {
                //Deshabilito la consola de trabajo
                CntWork.Enabled = false;
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (btnConectar.Text == "Conectar con SAP")
                {
                    //Conectamos con SAP
                    ...
                    {
                        toolStripStatusLabel1.Text = SapClass.cStatus;
                        btnConectar.Text = "Desconectar SAP";
                        CntWork.Enabled = true;
                        accion = 0;
                        ctrlCamposSN();
                    }                    
                }
